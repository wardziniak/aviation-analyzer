...
import com.wardziniak.aviation.importer.external.model.{AircraftBaseDTO, AircraftDTO, FlightSnapshotDTO}
...
trait AircraftDataDownloader extends DataDownloader[AircraftDTO] {
  import com.wardziniak.aviation.importer.external.model.AircraftDTO.readableAsAircraftDTO
